...
sshpass -p "root" scp $WORKSPACE/target/CounterWebApp.jar root@172.17.0.2:/home/Distors/apache-tomcat-9.0.5/webapps
...
sshpass -p "root" scp $WORKSPACE/target/CounterWebApp.jar root@172.17.0.4:/home/Distors/apache-tomcat-9.0.5/webapps
